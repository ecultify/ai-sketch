        ...
        <div className="flex-1 relative p-4">
          {isLoading ? (
            <div className="w-full h-full relative">
              {generatedImage && (
                <div className="absolute inset-0 rounded-lg overflow-hidden border-2 border-zinc-200 opacity-50">
                  <img
                    src={generatedImage}
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-zinc-50/80 backdrop-blur-sm rounded-lg">
            ...
            <div className="w-full h-full relative rounded-lg overflow-hidden border-2 border-zinc-200 shadow-xl bg-white">
              <img
                src={displayImage}
                alt={imagination === 0 ? "Your doodle" : "Generated anime poster"}
